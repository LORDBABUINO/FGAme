...
class Screen(object):
    ...
    def __init__(self, width, height, pos=(0, 0), zoom=1, background='white'):
        self.width = width
        self.height = height
        self.pos = Vector(*pos)
        self.zoom = zoom
...
class Canvas(Screen):
    ...
    def __init__(self, width, height, pos=(0, 0), zoom=1, background='white'):
        super(Canvas, self).__init__(width, height, pos, zoom, background)
        self._drawing_funcs = {}
    
    def start(self):
        self.paint_background(self.background)
